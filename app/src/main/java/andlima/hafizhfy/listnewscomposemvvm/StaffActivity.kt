...
import andlima.hafizhfy.listnewscomposemvvm.viewmodel.StaffViewModel
...
@Composable
fun ItemStaff(staff: GetAllStaffResponseItem) {
...
//                    pindah.putExtra("SELECTED_DATA", staff)
...
//                    painter = painterResource(id = andlima.hafizhfy.listnewscomposemvvm.R.drawable.cat),
                ...
                Column(modifier = Modifier
                    ...
                    Text(text = staff.name, fontWeight = FontWeight.Bold, fontSize = 20.sp)
...
fun DefaultPreview3() {
    ListNewsComposeMVVMTheme {
//        Greeting("Android")
        ItemStaff(GetAllStaffResponseItem("", "", "", "", "", "", ""))
    }
}